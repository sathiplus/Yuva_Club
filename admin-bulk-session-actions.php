...
if (!is_array($selectedStudents) || $selectedStudents === []) {
    audit_log_event($admin['id'], $admin['role'], $admin['organization_id'], 'admin.bulk_session.update', 'student', null, false, ['reason' => 'empty_selection']);
...
audit_log_event($admin['id'], $admin['role'], $admin['organization_id'], 'admin.bulk_session.update', 'student', null, true, ['count' => count($selectedStudents)]);
