...
BEGIN
    CREATE TABLE dbo.ai_mentor_delivery_reviews (
        ...
        coaching_provider NVARCHAR(40) NULL,
        coaching_model NVARCHAR(120) NULL,
        ...
        visual_analysis_status NVARCHAR(20) NOT NULL CONSTRAINT df_ai_mentor_delivery_visual_status DEFAULT N'Unavailable',
        ...
        CONSTRAINT ck_ai_mentor_delivery_visual_status CHECK (visual_analysis_status IN ('Unavailable','Sampled','Failed')),
