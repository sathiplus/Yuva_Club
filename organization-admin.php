...
<main>
  <section class="band">
    ...
    <section class="form-card"><h2>Organization Students</h2>
      ...
      <?php else: ?><div class="table-wrap"><table><thead><tr><th>YUVA ID</th><th>Name</th><th>Program</th><th>School</th><th>Status</th></tr></thead><tbody>
        <?php foreach ($students as $studentId => $student): $studentRecord = $records[$studentId] ?? []; ?><tr><td><?php echo e((string) $studentId); ?></td><td><?php echo e(student_display_name($student)); ?></td><td><?php echo e((string) ($student['Program Group'] ?? '')); ?></td><td><?php echo e((string) ($student['School'] ?? '')); ?></td><td><?php echo e((string) ($studentRecord['approved'] ?? 'Pending')); ?></td></tr><?php endforeach; ?>
