...
$stateCases = [
    ...
    ResearchSubmissionState::REVIEW_PENDING_APPROVAL => [$completeResearch, ['status' => 'Draft'], false, ''],
    ResearchSubmissionState::REVIEW_APPROVED => [$completeResearch, ['status' => 'Applied'], false, ''],
    ResearchSubmissionState::REVIEW_UNAVAILABLE => [$completeResearch, ['status' => 'Failed'], false, ''],
