...
assert.ok(portal.includes('AI Mentor Practice Coaching')&&portal.includes('AI Practice Score')&&portal.includes('Benchmark Beaten'),'Student score and benchmark experience missing');
...
assert.ok(parent.includes('AI Practice Score · coaching only')&&parent.includes('not an official competition result')&&!parent.includes("another student's"),'Parent safe view missing');
