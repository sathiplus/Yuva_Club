...
Assert-FileContains 'organization-admin.php' 'student_organization_id\(\$student\) === \$organizationId' 'Organization dashboard must filter student records by OrganizationId.'
