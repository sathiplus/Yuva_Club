...
$deleted=is_array($record)&&presentation_media_manager()->delete($studentId,$record);
if(is_array($record)){unset($records[$studentId]);write_json_file(presentation_media_file(),$records);}
