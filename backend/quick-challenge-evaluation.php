...
final class QuickChallengeEvaluationService
{
    ...
    {
        $yuvaId=strtoupper(trim($yuvaId));if(!(bool)call_user_func($this->hasFeature,$yuvaId,'ai_quick_challenge_scoring'))return ['status'=>'disabled'];
